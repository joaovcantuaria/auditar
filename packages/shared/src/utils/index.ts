 ...
 * @returns    - "2025-00042"
 */
export function formatarProtocolo(ano: number, seq: number): string {
 ...
 */
export function calcularPrazoTotalFluxo(
  etapas: ReadonlyArray<{ prazosDiasUteis: number }>,
): number {
...
const FERIADOS_NACIONAIS: Array<{ month: number; day: number }> = [
 ...
 */
export function calcularPrazoFinal(start: Date, dias: number): Date {
 ...
 * (inclusive).
 */
export function calcularDiasRestantes(start: Date, end: Date): number {
